...
// Handwerker-Bilder basierend auf Kategorie
    ...
    try {
      ...
      if (response.ok) {
        ...
        const removeSpecials = (slicedAusgewählterTag = "") => {
          let res = "";
          for (let i = 0; i < slicedAusgewählterTag.length; i++) {
        ...
        await fetch(`http://localhost:8080/gebucht/${id}/${res}`, {
          method: "POST",
        });
        ...
        <div className="flex flex-row w-full max-w-4xl bg-white p-8 rounded-lg shadow-2xl">
                  ...
                  <div key={index} className="react-modals">
                    ...
                    >
                      <p className="text-lg font-semibold">
                        {tagName}, {datum.toLocaleDateString("de-DE")}
                      </p>
                      <p className="text-gray-600">
                        {arbeitsZeit.von} - {arbeitsZeit.bis}
                      </p>
                    </button>
                    {isOpen && (
                        ...
                        <div className="p-8 border w-96 shadow-lg rounded-md bg-white" style={{ position: "relative" }}>
                          ...
                          <div className="text-center">
                            ...
                            <div className="flex justify-center mt-4">
                              <button onClick={(e) => buchen(e)} className={styles.button}>
                                Buchen
                              </button>
                            </div>
                          </div>
          ...
          <div className="flex-1 flex flex-col items-center">
            ...
            <div className="space-y-4">
              <p className="text-lg">
                <strong className="text-yellow-500">Stadt:</strong> {stadt}
              </p>
              <p className="text-lg">
                <strong className="text-yellow-500">Kategorie:</strong> {kategorie}
              </p>
              <p className="text-lg">
                <strong className="text-yellow-500">Telefonnummer:</strong> {telefon}
              </p>
              <p className="text-lg">
                <strong className="text-yellow-500">Stundenlohn:</strong> {stundenlohn}€
              </p>
            </div>
          </div>
        </div>
