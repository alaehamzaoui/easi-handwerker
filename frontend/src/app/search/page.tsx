      ...
      <div className="flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-8 mb-12 justify-center items-center">
        <div className="relative w-full md:w-1/4 searchable-list">
          <input
            ...
            className="w-full px-6 py-4 border border-yellow-500 rounded-lg bg-gray-800 text-white placeholder-yellow-500 focus:outline-none focus:border-yellow-400 shadow-lg transition-transform transform hover:scale-105"
          />
          ...
          <ul className="absolute option-list overflow-y-scroll max-h-64 w-full bg-gray-800 text-white rounded-lg shadow-lg scale-0 opacity-0 transition-all duration-200 origin-top-left z-10">
